...
- This is the daily stock price visualization for ___BRK.B(Berkshire Hathaway Inc)___, the data trace back to three month, and when you move you cursor on the graph, the nicely plotly feature will show the open high low close price at a specific day. 
